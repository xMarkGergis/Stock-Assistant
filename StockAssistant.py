...
st.markdown(
"<div class='translucent'><p class='title-text'><em>BearBullBuddy</em></p><p class='subtitle-text'><em>your stock analysis assistant</em></p></div>",
unsafe_allow_html=True)
...
set_background('static/images/bg.png')
